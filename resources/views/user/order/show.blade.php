...
@section('main-content')
    <div class="card">
        <h5 class="card-header">Pesanan <a href="{{route('order.pdf',$order->id)}}" class=" btn btn-sm btn-primary shadow-sm float-right"><i class="fas fa-download fa-sm text-white-50"></i> Unduh PDF</a>
        </h5>
        <div class="card-body">
            @if($order)
                            ...
                            <div class="col-lg-6 col-lx-4">
                                <div class="order-info">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>Total</td>
                                            <td> : {{format_rupiah($order->total_amount,2)}}</td>
                                        </tr>
                                        <tr>
