    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Masukkan judul Produk"  value="{{old('title')}}" class="form-control">
          @error('title')
    ...
    if(cat_id !=null){
      ...
      $.ajax({
        ...
        success:function(response){
          ...
          var html_option="<option value=''>--Pilih subkategori--</option>"
          if(response.status){
