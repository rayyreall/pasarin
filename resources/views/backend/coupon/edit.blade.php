    ...
    <div class="card-body">
      <form method="post" action="{{route('coupon.update',$coupon->id)}}">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
              <label for="type" class="col-form-label">Tipe Kupon <span class="text-danger">*</span></label>
          ...
          <div class="form-group">
              <label for="inputTitle" class="col-form-label">Nilai Kupon <span class="text-danger">*</span></label>
