                                        ...
                                        {{-- {{Helper::getAllProductFromCart()}} --}}
                                            @foreach(Helper::getAllProductFromWishlist() as $data)
                                                    ...
                                                    <li>
                                                        ...
                                                        <p class="quantity">{{$data->quantity}} x - <span class="amount">{{format_rupiah($data->price)}}</span></p>
                                                    </li>
                                            @endforeach
                                    </ul>
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount">{{format_rupiah(Helper::totalWishlistPrice())}}</span>
                                        </div>
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        ...
                                        <a href="{{route('cart')}}">Tampilkan Keranjang</a>
                                    </div>
                                    <ul class="shopping-list">
                                        {{-- {{Helper::getAllProductFromCart()}} --}}
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Total</span>
                                            <span class="total-amount">{{format_rupiah(Helper::totalCartPrice())}}</span>
                                        </div>
                                        <a href="{{route('checkout')}}" class="btn animate">Pembayaran</a>
                                    </div>
                                </div>
                            @endauth
                            <!--/ End Shopping Item -->
