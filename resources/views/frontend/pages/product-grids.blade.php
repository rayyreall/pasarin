...
@section('title', config('app.name') . ' || PRODUCT PAGE')
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                @endphp
                                                <p class="price"><del class="text-muted">{{format_rupiah($product->price)}}</del>   {{format_rupiah($org)}}  </p>
...
<style>
    ...
    .owl-carousel .owl-nav {
        display: none; /* atau ubah tampilannya */
    }
    .filter_button{
        /* height:20px; */
        text-align: center;
