						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4>Hubungi Kami</h4>
									<h3>Kirimkan Pesan kepada Kami @auth @else<span style="font-size:12px;" class="text-danger">[Anda harus login terlebih dahulu]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										...
										<div class="col-12">
											<div class="form-group message">
												...
												<textarea name="message" id="message" cols="30" rows="9" placeholder="Tulis pesan Anda"></textarea>
											</div>
										</div>
										<div class="col-12">
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								...
								<div class="single-info">
									...
									<ul>
										<li><a href="mailto:agustinnurvia11@gmail.com">@foreach($settings as $data) {{$data->email}} @endforeach</a></li>
									</ul>
								</div>
								<div class="single-info">
